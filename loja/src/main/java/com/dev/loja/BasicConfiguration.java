...
public class BasicConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests().antMatchers("/administrativo/produtos/**").hasAnyAuthority("Gerente").
		antMatchers("/login/**").hasAnyAuthority("Gerente").and().formLogin()
